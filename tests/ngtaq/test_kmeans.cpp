#include "../../lib/NGT/NGTAQ/KMeansCentering.h"
#include <cstdio>
#include <cmath>
#include <vector>
#include <random>
...
static void test_k_selection() {
    EXPECT_EQ(NGT::NGTAQ::select_k(100000), 256u);
    EXPECT_EQ(NGT::NGTAQ::select_k(1000000), 1000u);
    EXPECT_EQ(NGT::NGTAQ::select_k(10000000), 10000u);
    EXPECT_EQ(NGT::NGTAQ::select_k(5000000000ull), 4000000u);
}
...
static void test_separable_clusters() {
    ...
    NGT::NGTAQ::KMeansCentering km(K, D, 42);
...
static void test_centroid_count() {
    ...
    NGT::NGTAQ::KMeansCentering km(K, D, 1);
    km.train(data.data(), N);
