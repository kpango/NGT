...
// NGTAQv2 clean benchmark: pre-built cache + real SIFT-1M test queries + exact GT
...
int main(int argc, char** argv) {
    ...
    // ---- Load pre-built NGTAQv2 index ----
    std::cout << "[Load] NGTAQv2 from: " << cache_dir << "\n"; std::cout.flush();
    ...
    std::cout << "=== NGTAQv2 gamma sweep (k=" << k << ", nq=" << nq << ") ===\n";
    std::cout << std::left
              << std::setw(12) << "gamma"
