...
int main(int argc, char** argv) {
    ...
    auto mode = ::ArcFlare::ArcFlareIndex::ReorderMode::BFS;
    if      (mode_s == "rcm")    mode = ::ArcFlare::ArcFlareIndex::ReorderMode::RCM;
    else if (mode_s == "gorder") mode = ::ArcFlare::ArcFlareIndex::ReorderMode::GORDER;
    ::ArcFlare::ArcFlareIndex idx = ::ArcFlare::ArcFlareIndex::load(in + "/aqindex");
    idx.loadV2(in);
