// tests/arcflare/build_arcflarev2_ann.cpp
// Build ArcFlare index from an ANN-Benchmarks HDF5 file.
//
// Usage: build_arcflarev2_ann <hdf5_path> <out_dir> [metric=l2|angular|cosine]
...
int main(int argc, char** argv) {
    ...
    const int D_eff = NGT::ArcFlare::pad_dim_for_v2(D);
    ...
    // 4. Build AQv2 index
    ArcFlare::ArcFlareIndex::Property aq_prop;
    ...
    fprintf(stderr, "[ArcFlare] Building (k_clusters=%d, max_edges=%d, alpha=%.2f)...\n",
        k_clusters, max_edges, alpha);
    ArcFlare::ArcFlareIndex idx = ArcFlare::ArcFlareIndex::fromNGTv2(ngt_tmp, aq_prop);
    fprintf(stderr, "[ArcFlare] Build done (%.1fs)\n", elapsed_s(t0));
